...
(defun gtags-produce-tags-if-needed (dir)
...
(defun gtags-create-or-update ()
  ...
  (interactive)
  (gtags-produce-tags-if-needed (read-directory-name
                            "gtags: top of source tree:" default-directory)))

(defun gtags-add-gtagslibpath (libdir &optional del)
...
(defun gtags-print-gtagslibpath ()
