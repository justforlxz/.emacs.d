...
(define-obsolete-function-alias 'ensure-module-deps 'require-packages "wen packages 1.1")
...
(defun install-packages ()
  ...
  (unless (packages-installed-p)
    ...
    (require-packages preloaded-packages)
    ))
...
(defun update-packages (&optional arg)
  "Update Wen's packages. his includes package installed via `require-package'."
  (interactive "P")
